...
namespace sep.backend.v1.Migrations
{
    ...
    [Migration("20241101064123_AddColumOldTeacherOfClassEnrollment")]
    partial class AddColumOldTeacherOfClassEnrollment
    {
            ...
            modelBuilder.Entity("sep.backend.v1.Data.Entities.ClassApplication", b =>
                {
                    ...
                    b.Property<int?>("ClassApplicationCategoryId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ClassApplicationCategoryId");

                    b.HasIndex("PupilId");

                    b.HasIndex("SemesterId");

                    b.ToTable("ClassApplication");
                });
            ...
            modelBuilder.Entity("sep.backend.v1.Data.Entities.ClassApplicationCategory", b =>
                {
                    ...
                    b.ToTable("ClassApplicationCategory");
                });
            ...
            modelBuilder.Entity("sep.backend.v1.Data.Entities.ClassApplication", b =>
                {
                    b.HasOne("sep.backend.v1.Data.Entities.ClassApplicationCategory", "ClassApplicationCategory")
                        ...
                        .HasForeignKey("ClassApplicationCategoryId");
