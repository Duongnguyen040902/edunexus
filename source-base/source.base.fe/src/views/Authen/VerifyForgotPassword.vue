  ...
  <div class="authentication-wrapper authentication-basic px-4">
    <div class="authentication-inner">
      <div class="card px-sm-6 px-0">
        ...
        <form @submit.prevent="handleSubmitConfirmCodeResetPassword">
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const { verifyEmailRequest, errorVerify, handleSubmitConfirmCodeResetPassword } = authComposable;
    const token = Cookie.get('token-forgot-password') ?? '';
