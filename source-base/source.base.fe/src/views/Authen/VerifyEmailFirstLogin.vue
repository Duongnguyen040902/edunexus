  ...
  <div class="authentication-wrapper authentication-basic px-4">
    <div class="authentication-inner">
      <div class="card px-sm-6 px-0">
        ...
        <form @submit.prevent="handleConfirmCodeVerifyFirstLogin">
          <div class="mb-6 fv-plugins-icon-container">
            ...
            <div v-if="errorCodeConfirmFirstLogin.VerificationCode" class="text-danger">{{
                errorCodeConfirmFirstLogin.VerificationCode[0]
              }}</div>
          </div>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const { verifyEmailRequest, errorCodeConfirmFirstLogin, handleConfirmCodeVerifyFirstLogin } = authComposable;
